...
slug: /software-blog/slow_computer/
image: /images/software-blog/slow_computer.jpg
---
...
<Tip content="To speed things up create `.sh/.bat` files so that you can run repeated commands with a click of a button" />
...
<sub>
  Photo by{' '}
  <a href="https://unsplash.com/@zane4004?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">
    Zane Lee
  </a>{' '}
  on{' '}
  <a href="https://unsplash.com/s/photos/old-computer?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">
    Unsplash
  </a>
</sub>
