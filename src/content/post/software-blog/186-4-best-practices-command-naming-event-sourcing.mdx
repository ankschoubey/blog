...
<Tip
  content="**General Tip**: Commands always follow a similar pattern to service methods, with a <b>{Verb}{Noun}</b> format. So, <b>SendEmailCommand</b> is better than <b>EmailSendCommand</b>, which sounds more like an event."
  type="note"
/>
