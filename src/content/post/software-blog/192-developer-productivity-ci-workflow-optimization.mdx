...
**Note**: I could not share images of my workflow because I use TeamCity at work. I have added some images that found on the internet.
...
This will allow you to easily see if all the steps in the chain from one view.
